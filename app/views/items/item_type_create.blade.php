...
@section('content')
    ...
    <section class="content-header">
    	<h1>Create Item Type <small>Form</small></h1>
        <ol class="breadcrumb">
            <li>
	...
	{{ Form::open(array('route' => 'items.type.create', 'class' => 'form-horizontal', 'role' => 'form')) }}

		<div class="form-group">

			{{ Form::label('type', 'Item Type:', ['class' =>'col-sm-2 control-label']) }}
			<div class="col-sm-6">
				{{ Form::text('type', null, ['class' =>'form-control', 'placeholder' => 'Item Type']) }}
