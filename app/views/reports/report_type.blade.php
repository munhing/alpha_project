...
@section('content')
    ...
    <section class="content-header">
        <h1>Report Type<small>List</small>
            <a href="{{ URL::route('reports.type.create') }}" class="btn btn-sm pull-right btn-default">
                <i class='fa fa-plus fa-fw'></i>New Report Type
            </a>
                    ...
                    @if($reportType->count())
                        @foreach($reportType as $type)
                            ...
                            <tr>
                                ...
                                <td>{{ $type->type }}</td>
                                <td>
                                    <a href="{{ URL::route('reports.type.edit' , $type->id) }}" class="btn btn-xs btn-warning">
                                        <i class="fa fa-edit"></i>
                                    </a>

                                    {{ Form::open(['route' => ['reports.type.delete', $type->id], 'style' => 'display:inline']) }}
