...
@section('content')
    ...
    <section class="content-header">
        ...
        <h1>
            Report No: {{ $certificate->cert_no }} <small>{{ $certificate->client->name }}</small>
        </h1>
        ...
        <div class="col-lg-8">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    {{ Form::open(array('route' => ['certificates.items.add', $certificate->id], 'role' => 'form')) }}
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    {{ Form::open(array('route' => ['certificates.item.create', $certificate->id], 'class' => 'form-horizontal', 'role' => 'form')) }}
                        {{ Form::hidden('client_id', $certificate->client_id) }}
                        <div class="form-group">
