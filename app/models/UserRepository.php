...
class UserRepository
{
    ...
    public function signup($input)
    {
		...
		$user->client_id = array_get($input, 'client_id');
		...
		//$user->attachRole($admin);
		  $user->roles()->attach( array_get($input, 'role_id') ); 
        }
    ...
    public function changePassword($input)
    {
        ...
        if ($user) {
            ...
            $correctPassword = Hash::check(
                isset($input['password_old']) ? $input['password_old'] : false,
                $user->password
            );
    ...
    public function userChangePassword($input)
    {
        $result = false;
        $user   = Confide::getUserByEmailOrUsername($input);
    ...
    {
        $result = false;
        $user   = Confide::getUserById($input['id']);
